...
export default function Home () {
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-between min-h-full gap-20 bg-[#092635]">
      <div className="w-full h-4/5 flex flex-col items-center justify-between gap-20">
        <div className="w-[90%] h-1/2 flex flex-col justify-start mt-20 gap-5 bg-[#1B4242] p-10 rounded-md shadow-md">
        ...
        <div className="min-w-full min-h-[500px] flex justify-center items-center border-t border-slate-400 p-10 bg-cover bg-center filter" style={{"background-image": "url('/images/bg-ss-horizons.png')"}}>
